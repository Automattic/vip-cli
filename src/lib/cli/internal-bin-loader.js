const internalBinLoaders = {
	...
	'vip-app-deploy-token': () => import( '../../bin/vip-app-deploy-token' ),
	'vip-app-deploy-token-generate': () => import( '../../bin/vip-app-deploy-token-generate' ),
	...
	'vip-integration': () => import( '../../bin/vip-integration' ),
	'vip-integration-validate': () => import( '../../bin/vip-integration-validate' ),

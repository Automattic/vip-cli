...
module.exports.set = function( token ) {
	return keychain.setPassword( SERVICE, SERVICE, token );
};

module.exports.get = async function() {
	const token = await keychain.getPassword( SERVICE, SERVICE );
	try {
...
module.exports.purge = async function() {
	return await keychain.deletePassword( SERVICE, SERVICE );
};

...
command()
	...
	.option( 'media-redirect', 'Domain to redirect for missing media files. This can be used to still have images without the need to import them locally.' )
	.examples( examples )
	.argv( process.argv, async ( arg, opt ) => {
		...
		const instanceDataWithSlug = {
			...
			mediaRedirect: opt.mediaRedirect || '',
		};

...
* build(deps-dev): bump @types/node from 22.15.27 to 22.15.29
* build(deps-dev): bump @babel/core from 7.27.3 to 7.27.4 in the babel group
* chore(deps): update `tar-fs` to 2.1.3 to fix CVE-2025-48387

**Full Changelog**: https://github.com/Automattic/vip-cli/compare/3.17.0...3.17.1

### 3.17.0

* Allow URLs in the SQL import command

**Full Changelog**: https://github.com/Automattic/vip-cli/compare/3.16.1...3.17.0

### 3.16.1

* build(deps-dev): bump @types/node from 22.15.24 to 22.15.27
...
* build(deps-dev): bump @types/dockerode from 3.3.38 to 3.3.39
* build(deps-dev): bump @types/node from 22.15.18 to 22.15.21
* feat(dev-env) Update ES to elasticsearch:8.18.1
* build(deps-dev): bump @types/node from 22.15.21 to 22.15.24
* build(deps-dev): bump @babel/core from 7.27.1 to 7.27.3 in the babel group
